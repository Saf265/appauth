...
function Signup(){
  return(
    <section className="items-center justify-center w-full h-screen flex">
      <form action={createUser} className="flex flex-col gap-4 items-center justify-center bg-slate-300 p-4 rounded-lg w-96">
        ...
        <button type="submit" className="btn btn-block btn-secondary">Sign Up</button>
        ...
        <h1>No Accounts ?<Link href="./signup/signin" className="btn btn-link">Create one Here</Link></h1>
      </form>
    </section>
  )
}
